...
\end{verbatim}
where the description of the material should be subsituted in the note above. Note that the APS prefers to have works that are cited in a supplement to also be cited in the main document.
